...
class UserApi {
  ...
  AdharVerification(id:string, data:any){
    return api._putFormData(`${this._url.ADHAR_VEFIFICATION}/${id}/upload-aadharCard`, data)
  }

// selfie verification
  SelfieVerification(id:string, data:any){
    return api._putFormData(`${this._url.SELFIE_VERIFICATION}/${id}/upload-photo`, data)
  }
