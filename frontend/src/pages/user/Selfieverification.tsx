      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="flex items-center justify-center gap-4 pt-6 pb-2 px-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-green-400 text-xs sm:text-sm font-semibold">Document Upload</p>
          ...
          <div className="flex items-center gap-2">
            <AnimatePresence mode="wait">
              {step2Status === "completed" ? (
                <motion.div key="done" className="w-9 h-9 rounded-full bg-green-500 flex items-center justify-center"
        ...
        <div className="flex items-start justify-center px-4 sm:px-6 md:px-8 py-6">
          <motion.div className="w-full max-w-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <AnimatePresence>
              {validationError && (
                <motion.div className="flex items-start gap-3 bg-red-500/10 border border-red-500/30 rounded-xl px-4 py-3 mb-4"
